                ...
                <div className="flex grow overflow-auto">
                    {
                        ...
                        <Link to={"/dashboard"} className="flex items-center gap-2 font-semibold my-4 text-lg text-zinc-700"><AiFillDashboard /> <span>Dashboard</span></Link>
                        ...
                        <div className="my-4">
                            ...
                            <div className="text-zinc-500 mx-3 flex flex-col gap-2 py-3">
                                <Link to={"/dashboard/users/list"} className="flex items-center gap-2 hover:text-zinc-700 transition"><span><FaList /></span><span>Listar usuários</span></Link>
                            </div>
                        </div>
                        ...
                        <div className="my-4">
                            ...
                            <div className="text-zinc-500 mx-3 flex flex-col gap-2 py-3">
                                <Link to={"/dashboard/topics/list"} className="flex items-center gap-2 hover:text-zinc-700 transition"><span><FaList /></span><span>Listar tópicos</span></Link>
                            </div>
                        </div>
                        ...
                        <div className="my-4">
                            ...
                            <div className="text-zinc-500 mx-3 flex flex-col gap-2 py-3">
                                <Link to={"/dashboard/posts/list"} className="flex items-center gap-2 hover:text-zinc-700 transition"><span><FaList /></span><span>Listar postagens</span></Link>
                                <Link to={"/dashboard/posts/new-post"} className="flex items-center gap-2 hover:text-zinc-700 transition"><span><FaPlus /></span><span>Criar postagem</span></Link>
                            </div>
                        </div>
                    </div>
                    }
