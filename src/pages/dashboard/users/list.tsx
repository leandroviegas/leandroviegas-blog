                    ...
                    <div className="bg-white dark:bg-zinc-900 rounded-lg p-4 mx-4 my-8 shadow-lg">
                        <div className="flex gap-2 my-4">
                            <form className="h-8 flex items-center">
                                ...
                                <input type="text" placeholder="Procurar" className="outline-none h-full px-2 py-1 text-gray-400 bg-transparent border-b" />
                            </form>
                        </div>
                        <hr className="my-4" />
                        <div className="my-6">
                            <button onClick={() => setPopup("user-form")} className="shadow-md shadow-indigo-500/30 hover:scale-110 bg-indigo-500 hover:bg-indigo-700 transition font-semibold text-white px-3 py-1 rounded">
                                Novo usuário
                            </button>
                        </div>
                        <div className="my-4 grid sm:grid-cols-2 lg:grid-cols-3 gap-2 sm:gap-4">
                            {users.data?.map(user => {
                                return (
                                    <div key={user?._id} className="border dark:border-transparent dark:bg-zinc-800 border-zinc-300 rounded-xl flex flex-col">
