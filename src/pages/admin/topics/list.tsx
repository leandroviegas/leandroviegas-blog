            ...
            {(topics.status === "success" && topics.data.length > 0) &&
                <div className="container">
                    <div className="bg-white rounded-lg p-4 mx-4 my-8 shadow-lg">
                        ...
                        <div className="my-6">
                            <button onClick={() => setPopup("topic-form")} className="shadow-lg shadow-violet-500/30 hover:scale-110 bg-violet-600 hover:bg-violet-700 transition font-semibold text-white px-3 py-1 rounded">Novo Tópico</button>
                        </div>
                                ...
                                return (
                                    <div key={topic?._id} className="border border-zinc-300 rounded-xl flex flex-col">
                                        ...
                                        <div className="p-3  bg-violet-600 shadow-xl shadow-violet-500/40 rounded-b-xl font-semibold flex items-center gap-4 flex-wrap">
                                            ...
                                            <button onClick={() => { setSelectedTopic(topic); setPopup("delete"); }} className="bg-red-600 text-white hover:bg-red-700 px-3 transition rounded py-1">Apagar</button>
                                        </div>
                                    </div>
                                )
                            })}
                    ...
                    <div className="mt-8 mx-2 md:mx-6">
                        ...
                        <div className="flex gap-6 text-indigo-800 mt-6">
                            ...
                            <div>
                                ...
                                <button onClick={() => setPopup("topic-form")} className="bg-indigo-600 hover:bg-indigo-700 transition font-semibold text-white px-3 py-1 rounded my-4">Nova Tópico</button>
                            </div>
                        </div>
                    </div>
                </div>
