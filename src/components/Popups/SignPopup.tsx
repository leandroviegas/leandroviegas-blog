            ...
            <div data-aos="fade-down" className="md:top-4 absolute max-h-full h-full md:h-auto overflow-y-auto mx-auto bg-white rounded-lg max-w-screen max-w-[550px] w-full shadow">
                <div className="p-8 text-zinc-700 rounded-t-lg h-auto">
                    ...
                    <div className="w-full flex justify-center py-3">
                        <button className="bg-red-500 rounded-lg text-white transition hover:bg-red-600"><a className="flex items-center px-4 py-2 gap-2 font-semibold" href={`http://localhost:3333/auth?originRequestLink=${typeof window !== "undefined" ? window.location.href : ""}`}><span><BsGoogle /></span><span className="text-sm opacity-90 font-normal">Entrar com Google</span></a></button>
                    </div>
