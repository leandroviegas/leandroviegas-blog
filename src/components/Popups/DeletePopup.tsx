...
const DeletePopup = ({
  ...
  return (
    <>
      {open && (
        <OpaqueBackground closeCallback={onCancel}>
          <div
            data-aos="fade-down"
            className="bg-white max-w-[720px] flex flex-col w-screen h-screen sm:max-h-[16rem] rounded-lg"
          >
            <div className="grow flex flex-col">
              <div className="flex gap-2 justify-between items-center rounded-t-lg bg-violet-700 text-white py-3">
                <h1 className="text-xl mx-4 rounded-t-lg">
                  Confirmar exclusão
                </h1>
                <button
                  onClick={onCancel}
              ...
              <div className="mx-8 my-2 grow flex items-center">
                ...
                <div className="grow">
                  ...
                  <p className="font-thin my-2 text-zinc-700">
                    {texts.text || ""}
                  </p>
                </div>
              </div>
            ...
            <div className="flex items-center justify-between gap-6 flex-wrap p-4">
              <button
                type="button"
                onClick={onDelete}
                className="bg-red-600 hover:bg-red-700 hover:scale-105 text-white font-semibold px-3 transition py-2 rounded-lg"
              >
                {status === "loading" ? (
