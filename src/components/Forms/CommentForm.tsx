    ...
    return (
        <div className="px-6 py-2 bg-white rounded-lg">
            ...
            <form onSubmit={HandleComment}>
                <textarea value={content} onChange={e => setContent(e.target.value)} className="w-full h-12 rounded-lg resize-none py-2 text-zinc-600 outline-none" placeholder={referenceComment ? "Responder" : "Escreva um comentário"}> </textarea>
                <hr />
